(function ( $) {
    ...
    window.onbeforeunload = function () {
        localStorage.removeItem('moradam_seo_selected_se');
        localStorage.removeItem('moradam_bp_selected_pages');
        localStorage.removeItem('moradam_bp_offset');
        localStorage.removeItem('moradam_bp_top_filter');
        localStorage.removeItem('moradam_bp_filter_url');
        localStorage.removeItem('moradam_bp_selected_pages_keywords_stat_chart_scale');
        localStorage.removeItem('moradam_bp_pos_filter');
    };

    $(document).ready(function () {
        $('#moradam-seo-header-edit-domain-btn').click(function() {
            $('.moradam-seo-header-current-domain-block').hide();
            $('.moradam-seo-header-edit-domain-block').show();
        });
        $('#moradam-seo-header-cancel-domain-changing-btn').click(function() {
            $('.moradam-seo-header-current-domain-block').show();
            $('.moradam-seo-header-edit-domain-block').hide();
        });
        $('#moradam-seo-header-save-new-domain-btn').click(function() {
            if ($('#moradam-seo-header-edit-domain-input').val().length > 0) {
                if (localStorage.getItem('moradam_current_domain')) {
                    localStorage.removeItem('moradam_current_domain');
                }
                localStorage.setItem('moradam_current_domain', $('#moradam-seo-header-edit-domain-input').val());
                domain = localStorage.getItem('moradam_current_domain');
                $('#moradam-seo-header-current-domain').text(domain);
                get_se_list();
            } else {
        ...
        $("#se-select-apply-btn").click(function () {
            ...
            localStorage.setItem('moradam_seo_selected_se', selected_se);
            remove_all_in_tbody();
            setTimeout(function () {
        ...
        $('#dynamics-scale-filter .scale-tab-item').click(function () {
            if ( !$(this).hasClass('active')) {
                ...
                localStorage.setItem('moradam_seo_best_pages_chart_scale', scale);
                get_dynamics_data('update');
            }
        });
        ...
        $('#best-pages-filter-select-top-count').change(function () {
            ...
            localStorage.removeItem('moradam_bp_offset');
            localStorage.setItem('moradam_bp_top_filter', selected);
            remove_all_in_tbody();
            scrollCounter = 0;
            setTimeout(function() {
                get_best_pages_on_top();
        ...
        $('#bp-filter-url-apply-btn').click(function() {
            if ($('#bp-url-filter-input').val().length > 0) {
                ...
                localStorage.setItem('moradam_bp_filter_url', inputKeyword);
                localStorage.removeItem('moradam_bp_offset');
                remove_all_in_tbody();
                get_best_pages_on_top();
                $("#bp-url-filter-block").hide();
        ...
        $('.best-pages-keywords-stat-filter .scale-tab-item').click(function () {
            if ( !$(this).hasClass('active') ) {
                ...
                $(this).addClass('active');
                let scale = $(this).text().toLowerCase();
                localStorage.setItem('moradam_bp_selected_pages_keywords_stat_chart_scale', scale);
                setTimeout(function () {
        ...
        $(document).on('change', '.checkbox-tbl', function() {
            ...
            if ($(this).prop('checked') == true) {
                let selected_pages = JSON.parse(localStorage.getItem('moradam_bp_selected_pages'));
                let hash;
                let params = {
                    ...
                    $.ajax({
                        ...
                        success: function(resp) {
                            if (resp.result) {
                                ...
                                localStorage.removeItem('moradam_bp_selected_pages');
                                localStorage.setItem('moradam_bp_selected_pages', selected_pages);
                            }
                            get_selected_pages_dynamics_data();
                        },
        ...
        $('#bp-dynamics-filter-select-top-for-selected-pages').change(function () {
            enablePreloaderSelectedPagesChart();
            let selected = $(this).find(':selected').val();
            localStorage.setItem('moradam_bp_dynamics_top_filter_for_selected_pages', selected);
            setTimeout(function () {
                get_selected_pages_dynamics_data();
            }, 500);
        });
        ...
        $('#best-pages-on-top-filter-pos').change(function () {
            ...
            let selected = $(this).find(':selected').val();
            localStorage.removeItem('moradam_bp_offset');
            localStorage.setItem('moradam_bp_pos_filter', selected);
            remove_all_in_tbody();
            setTimeout(function() {
                get_best_pages_on_top();
            }, 500);
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if(resp.result.top_se.length > 0) {
                        ...
                        localStorage.setItem('moradam_seo_selected_se', top_se_id);
                        get_dynamics_data();
                        get_best_pages_on_top();
                } else {
    ...
    function get_dynamics_data(update) {
        ...
        if (localStorage.getItem('moradam_seo_selected_se')) {
            request_data.se = localStorage.getItem('moradam_seo_selected_se');
        } else {
            return false;
        }
        if (localStorage.getItem('moradam_seo_best_pages_chart_scale')) {
            request_data.scale = localStorage.getItem('moradam_seo_best_pages_chart_scale');
        } else {
    ...
    function set_difference_tops_data(series) {
        ...
        $.each(top_keywords, function (key, value) {
            ...
            $('#moradam-keywords-count-top' + value).text(numberWithSpaces(current));
            $('#moradam-increase-count-top' + value).text(numberWithSpaces(avg));
            if (!$('#moradam-increase-count-top' + value).hasClass(top_kw_color)) {
                $('#moradam-increase-count-top' + value).removeClass().addClass(top_kw_color + ' bold');
            }
            if (!$('#moradam-arrow-style-top' + value).hasClass(arrow_style)) {
                $('#moradam-arrow-style-top' + value).removeClass().addClass(arrow_style);
            }
            if (!$('#moradam-arrow-color-top' + value).hasClass(arrow_color)) {
                $('#moradam-arrow-color-top' + value).removeClass().addClass(arrow_color);
            }
        });
        setTimeout(function() {
            $('.preloader-best-pages-difference-top').css('display', 'none');
    ...
    function clear_best_pages_difference() {
        let top_keywords = [1,3,10,30,50,100];
        $.each(top_keywords, function (key, value) {
            $('#moradam-keywords-count-top' + value).text(numberWithSpaces(0));
            $('#moradam-increase-count-top' + value).text(numberWithSpaces(0));
            if (!$('#moradam-increase-count-top' + value).hasClass('')) {
                $('#moradam-increase-count-top' + value).removeClass().addClass('bold');
            }
            if (!$('#moradam-arrow-style-top' + value).hasClass('arrow-default')) {
                $('#moradam-arrow-style-top' + value).removeClass().addClass('arrow-default');
            }
            if (!$('#moradam-arrow-color-top' + value).hasClass('arrow-default-color')) {
                $('#moradam-arrow-color-top' + value).removeClass().addClass('arrow-default-color');
            }
        });
        setTimeout(function() {
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: function(tooltipItem) {
                            ...
                            label += tooltipItem.formattedValue + ' pages';
                            return label;
                        },
                        ...
                        title: function(tooltipItem, data) {
                            return 'Pages on TOP on ' + moment(tooltipItem[0].label, 'YYYY-MM-DD').format('MMM Do, YYYY');
                        }
                    }
                }
            },
    ...
    function get_selected_pages_dynamics_data() {
        ...
        if (localStorage.getItem('moradam_bp_selected_pages')) {
            let json_selected_pages = localStorage.getItem('moradam_bp_selected_pages');
        ...
        if (localStorage.getItem('moradam_bp_selected_pages_keywords_stat_chart_scale')) {
            request_data.scale = localStorage.getItem('moradam_bp_selected_pages_keywords_stat_chart_scale');
        } else {
            request_data.scale = 'month';
        }
        let params = {
            ...
            success: function(resp) {
                ...
                setTimeout(function() {
                    if (resp.result) {
                        ...
                        if (localStorage.getItem('moradam_bp_dynamics_top_filter_for_selected_pages')) {
                            selected_pages_top = 'series_' + localStorage.getItem('moradam_bp_dynamics_top_filter_for_selected_pages');
                        } else {
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: function(tooltipItem) {
                            ...
                            label += tooltipItem.formattedValue + ' keywords';
                            return label;
                        },
                        ...
                        title: function(tooltipItem, data) {
                            ...
                            let topN = 100;
                            if (localStorage.getItem('moradam_bp_top_filter')) {
                                topN = localStorage.getItem('moradam_bp_top_filter');
                            }
                            return 'Keywords on TOP ' + topN + ' on ' + moment(tooltipItem[0].label, 'YYYY-MM-DD').format('MMM Do, YYYY');
                        }
                    }
                },
            },
    ...
    function get_best_pages_on_top() {
        ...
        if (localStorage.getItem('moradam_bp_pos_filter')) {
            request_data.pos_filter = localStorage.getItem('moradam_bp_pos_filter');
        } else {
            request_data.pos_filter = 'all';
        }
        if (localStorage.getItem('moradam_bp_top_filter')) {
            request_data.top_filter = localStorage.getItem(('moradam_bp_top_filter'));
        } else {
            request_data.top_filter = 100;
        }
        if (localStorage.getItem('moradam_bp_filter_url')) {
            request_data.page_filter_type = 'match';
            request_data.page_filter = localStorage.getItem('moradam_bp_filter_url');
        }
        let params = {
            ...
            success: function(resp) {
                ...
                setTimeout(function() {
                    if (resp.result && resp.result.total > 0) {
                        ...
                        localStorage.setItem('moradam_bp_selected_pages', json_selected_pages);
                        set_total_count_of_websites_in_table_head(resp.result.total);
                        insert_moradam_best_pages_into_table(resp.result.pages);
                        get_selected_pages_dynamics_data();
                    } else {
    ...
    function insert_moradam_best_pages_into_table(pages, lastId) {
        $('.no-data-found').remove();
    ...
    $(window).scroll(function () {
        ...
        if($(window).scrollTop() == $(document).height() - $(window).height()) {
            ...
            if (allowScrollLoad == true) {
                ...
                if (localStorage.getItem('moradam_bp_offset')) {
                    request_data.offset = localStorage.getItem('moradam_bp_offset');
                } else {
                    localStorage.setItem('moradam_bp_offset', defaultOffset);
                    request_data.offset = localStorage.getItem('moradam_bp_offset');
                }
                if (localStorage.getItem('moradam_seo_selected_se')) {
                    request_data.se = localStorage.getItem('moradam_seo_selected_se');
                    ...
                    $.ajax({
                        ...
                        success: function(resp) {
                            if (resp.result != null && resp.result.total > 0) {
                                ...
                                insert_moradam_best_pages_into_table(resp.result.pages, lastId);

                                if (resp.result.pages.length == size) {
                                    let offset = localStorage.getItem('moradam_bp_offset');
                                    let newOffset = parseInt(offset) + parseInt(size);
                                    localStorage.setItem('moradam_bp_offset', newOffset );
                                }
                            }
                            $('.preloader-best-pages-table').css('display', 'none');
                        },
